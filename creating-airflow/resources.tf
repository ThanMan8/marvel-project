...
resource "aws_subnet" "private" {
  ...
  availability_zone       = element(data.aws_availability_zones.available.names, index(var.private_subnets, each.key)) # Ensure different AZ for each subnet
